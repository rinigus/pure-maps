...
Column {
    ...
    ComboBox {
        ...
        Component.onCompleted: {
            var key = app.conf.get("routers.stadiamaps.language");
        ...
        onCurrentIndexChanged: {
            ...
            app.conf.set("routers.stadiamaps.language", key);
        }
    }
