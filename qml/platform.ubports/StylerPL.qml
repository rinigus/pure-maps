...
QtObject {
    ...
    property string iconEditClear: "image://theme/erase" //Qt.resolvedUrl("../../icons/edit-clear-symbolic.svg")
    ...
    property string iconProfileMixed: Qt.resolvedUrl("../icons/sailfishos/profile-mixed-black.svg")
    property string iconProfileOffline: Qt.resolvedUrl("../icons/sailfishos/profile-offline-black.svg")
    property string iconProfileOnline: Qt.resolvedUrl("../icons/sailfishos/profile-online-black.svg")
